...
export default {
    ...
    Please_fill_the_Email_Adress: 'Please fill the Email Adress',
    ...
    PaiementsNet: 'Paiements Net',
    PaiementsSent: 'Paiements Sent',
    PaiementsReceived: 'Paiements Received',
    Recieved: 'Recieved',
    Sent: 'Sent',
    ProductQuantityAlerts: 'Product Quantity Alerts',
    ProductCode: 'Code',
    ...
    CustomerPaiementsReport: 'Customer Paiements Report',
    ...
    SupplierPaiementsReport: 'Supplier Paiements Report',
    Name: 'Name',
    Code: 'Code',
